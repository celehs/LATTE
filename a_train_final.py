...
def parse_arguments(parser):
    ...
    parser.add_argument('--results_filename', type=str, default="results_",
    ...
    parser.add_argument('--flag_save_attention', type=int, default=0,
...
if __name__ == '__main__':
    ...
    unlabel_directory = mdir + ARGS.test_directory
