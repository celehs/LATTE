...
def parse_arguments(parser):
    ...
    parser.add_argument('--train_directory', type=str,
                        default= "Simulation/SimDat/SimDat.1/train/",
                        help='Directory of train data ')
    parser.add_argument('--train_filename', type=str, default="train_data.csv",
                        help='Filename of the train data')
    parser.add_argument('--test_directory', type=str,
                        default= "Simulation/SimDat/SimDat.1/test/",
                        help='Directory of test data ')
    parser.add_argument('--test_filename', type=str, default="test_data.csv",
                        help='Filename of the test data')
    parser.add_argument('--embedding_filename', type=str, default="simdata_generate_rely/embedding_selected.csv",
                        help='Filename of the embedding_filename data')
    parser.add_argument('--key_code', type=str, default="S.1,S.3,S.5",  #PheCode:250.2
                        help='the name of key_code')
    parser.add_argument('--unlabel_directory', type=str,
                        default="Simulation/SimDat/SimDat.1/",
                        help='Directory of unlabeled data')
    parser.add_argument('--unlabel_filename', type=str, default="SimDat.1_unlabeled.csv",
    ...
    parser.add_argument('--colums_max', type=int, default=15,
                        help='data end column index')
    parser.add_argument('--epochs', type=int, default=40,
                        help='training epoches')
    parser.add_argument('--epoch_silver', type=int, default=5,
                        help='epoches of pre-training using silver labels', )
    parser.add_argument('--month_window', type=int, default=1,
                        help='month_window')
    parser.add_argument('--max_visits', type=int, default=33,
    ...
    parser.add_argument('--flag_traintest_sep', type=int, default=0,
                        help='flag_traintest_sep: if 1 --> train set and test set are different, 0 --> train set and test set are the same set, and the program will divide it into two parts' )
    parser.add_argument('--number_labels', type=int, default=50,
                        help='number_labels',)
    parser.add_argument('--embedding_dim', type=int, default=10,
                        help='dimensions of code embeddings', )
    parser.add_argument('--layers_incident', type=str, default="40",
...
if __name__ == '__main__':
    ...
    flag_traintest_sep = ARGS.flag_traintest_sep
