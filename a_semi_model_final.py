            ...
            if epoch_num%epoch_show==0 or epoch_num>epochs-2:
                ...
                if flag_save_attention>0:
                    ...
                    if epoch_num % 10 == 0 or epoch_num > epochs - 2:
                        savefile_name =filename_save+ flag_save+ "Attenation_value_patient_visit_code_prediction_label_weight_test.pkl"
                        ...
                        savefile_name =filename_save+ flag_save+ "_embedding_patient_ori_codeRW_codeVistRW_hiddenFCN_label_test.pkl"
                        with open(dirr_save + savefile_name, 'wb') as fid:
                        ...
                        savefile_name = filename_save + flag_save + "_embedding_patient_ori_hiddenFCN_label_train.pkl"
                        with open(dirr_save + savefile_name, 'wb') as fid:
                ...
                if epoch_num > epochs - 2 :
                    if True:
                        ...
                        dataframe = pd.DataFrame({'Patient_num': patient_num_test_total2,
                                                  ...
                                                  "Y_pred": y_pred_get2,
                                                  "Y_label:": y_true_get2})
                        dataframe.to_csv(dirr_save + "Incident_epoch"+str(epoch_num)+"_"+flag_save+"_"+ filename_save, index=True, sep=',')
                    ...
                    if True:
                        ...
                        dataframe.to_csv(dirr_save + "Prevalence_"+"_"+flag_save+"_"+filename_save, index=True, sep=',')
